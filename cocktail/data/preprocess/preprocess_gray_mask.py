...
if __name__ == '__main__':
    ...
    # n_labels = sys.argv[2] # coco: 182
    # os.makedirs(file_path.replace('segmentation', 'segmentation_color'), exist_ok=True)

    # colorizer = Colorize(int(n_labels))
    ...
    #     img_c.save(name.replace('segmentation', 'segmentation_color'))
